    ...
    return (
        ...
        <h2>Index</h2>
            ...
            <form onSubmit={createTweet}>
                ...
                <input type="text" id="title" className="tweet-title-input" value={titleInput} onChange={(e) => setTitleInput(e.target.value)}/>
                <label htmlFor="title">Author</label>
                <input type="text" id="author" className="tweet-author-input" value={authorInput} onChange={(e) => setAuthorInput(e.target.value)}/>
                <label htmlFor="year">Content</label>
                <input type="text" id="content" className="tweet-content-input" value={contentInput} onChange={(e) => setContentInput(e.target.value)}/>
